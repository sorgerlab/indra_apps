...
if __name__ == '__main__':
    with open('gene_list_fabian.txt', 'rt') as f:
        gene_names = [line.strip() for line in f.readlines()]
    with open('dyn_model_preassembled.pkl', 'rb') as f:
        pre_stmts = pickle.load(f)

    pysb_stmts = assemble_pysb(pre_stmts, gene_names)
